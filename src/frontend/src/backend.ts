...
export class Backend implements backendInterface {
    ...
    async getAllMessageTerminalEntries(): Promise<Array<MessageTerminalEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllMessageTerminalEntries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDashboardStatus(): Promise<DashboardStatus> {
        if (this.processError) {
            try {
                const result = await this.actor.getDashboardStatus();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitMessageTerminalEntry(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitMessageTerminalEntry(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateNTPStatus(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateNTPStatus(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateUptime(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateUptime();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
